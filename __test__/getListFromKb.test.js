...
test('10.1: GetListFromKb should return object with empty array when provided with empty string', () => {
  expect.assertions(1)
...
test('10.3: GetListFromKb should return object with array when search term is erronious', () => {
  expect.assertions(1)
